<template>
  <div class="l-budget-creation">
    <v-layout row wrap>
      ...
      <v-flex xs12 md2>
        <v-select label="Status" :items="states" v-model="budget.state">
        </v-select>
      </v-flex>
      ...
      >
        ...
        <v-flex xs12 md2>
          <span class="md-budget-item-subtotal white--text"
            >ITEM PRICE $ {{ item.subtotal }}</span
          >
        </v-flex>
      </v-layout>
      ...
      <v-flex xs12 md2 offset-md10>
        <v-btn
          block
          color="md-add-item-btn light-blue lighten-1"
      ...
      <v-flex xs12 md2 offset-md10>
        <span class="md-budget-item-total white--text"
          >TOTAL $ {{ budget.total_price }}</span
        >
      </v-flex>
      ...
      <v-flex xs12 md2 offset-md10>
        <v-btn
          ...
          @click.native="saveBudget(budget)"
          >Save</v-btn
        >
      </v-flex>
    </v-layout>
